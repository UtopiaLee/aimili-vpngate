...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/UtopiaLee/aimili-vpngate/main/install.sh)
```
...
```bash
curl -Ls https://raw.githubusercontent.com/UtopiaLee/aimili-vpngate/main/install.sh -o install.sh
